...
<body>	
	<div style="background-color:black; color:white;">
    	<h1>Shopping Cart</h1><span style="position:absolute; left:20px; top:4px; "><a href="Homepage.jsp" style="text-decoration:none; font-size:15px;">&#8592; Back to Homepage</a></span>
    </div>
    <div>
            ...
            <table>
                <%
                    try{
                        ...
                        String sql ="SELECT b.*, c.*, p.*, s.* from customer c join billingaddress b on c.custID = b.custID join shippingaddress s on c.custid = s.custid join cartitems ca on ca.custID = c.custID join product p on ca.productID = p.productID ";
                ...
                <tr>
                    ...
                    <td>
                        <a href="DeleteFromCart.jsp?productID=<%=productID %>" style="text-decoration: none;"><i style="font-size:24px;" class="fa">&#xf014;</i> </a>
                        <%=productName %><br> 
            ...
            <div class="payment">
                ...
                <table>
                    ...
                    <tr>
                    	<td>
                    		<hr>
			                <h4 style="margin-bottom:0px;">Billing Address:</h4>
			                <%=billingAddress %>, <%=billingPoscode %>, <%=billingCity %>, <%=billingState %>  <br>
			                
			                <h4 style="margin-bottom:0px;">Shipping Address:</h4>
			                <%=shippingAddress%>, <%=shippingPoscode%>, <%=shippingCity%>, <%=shippingState%><br>
		                </td>
                    </tr>
                </table><br><hr>
            	

                <button><a href="CheckOut.jsp?totalPrice=<%=totalPrice+10%>" style="text-decoration: none; color:white;">Proceed to Checkout</a></button><br><br>
            </div>
        </div>
    </div>
</body>
