...
<div class ="menu-bar">
    <ul>
        ...
        <li  class="active"><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
    </ul>
</div>
  ...
  <section class="w3-container"> 
    <div class="row">
        <div class="column">
            <img src="2p.png" alt="Denim Jeans" style="width:30%">
        </div>
    
        <div class="column">
          <h4>Size : <c:out value="${c.productsize}"/></h4>
          <h4>Description : <c:out value="${c.productdesc}"/></h4>
          <h4>Price : <c:out value="${c.productprice}"/></h4>
          <h4>Total Price : <c:out value="${c.ordertotalprice}"/></h4>
        </div>
      </div>
    <hr>
  </section>
